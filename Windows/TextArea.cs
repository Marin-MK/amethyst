...
namespace amethyst.Windows
{
    public class TextArea : Widget
    {
        ...
        public TextArea(IContainer Parent) : base(Parent)
        {
            ...
            Sprites["text"].Z = 2;
            Sprites["filler"] = new Sprite(this.Viewport, new SolidBitmap(1, 16, SystemColors.SelectionColor));
            Sprites["filler"].Visible = false;
            Sprites["filler"].Y = 2;
            Sprites["caret"] = new Sprite(this.Viewport, new SolidBitmap(1, 16, Color.BLACK));
            Sprites["caret"].Y = 2;
            Sprites["caret"].Z = 1;

...
namespace amethyst.Windows
{
    public class HScrollBar : BasicHScrollBar
    {
        ...
        protected override void Draw()
        {
            ...
            Sprites["slider"].Bitmap = new Bitmap(this.RealSliderWidth, this.SliderHeight - 1);
            Sprites["slider"].Bitmap.Unlock();
            Sprites["slider"].Bitmap.FillRect(this.RealSliderWidth - 1, this.SliderHeight - 1, sc);
            Sprites["slider"].Bitmap.Lock();
            Sprites["slider"].X = Arrow1Size + this.RealSliderPosition;
